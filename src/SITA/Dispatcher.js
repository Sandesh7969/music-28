...
import Functions from "./../RAM/functions.js";
...
export default async (client, message) => {
  client.kazagumo.on("playerStart", async (player, track) => {
    ...
    const card = new muzicard()
      ...
      const attachment = new AttachmentBuilder(buffer, { name: `ram.png` });
   ...
   .setEmoji(`1177656045099827290`)
    ...
    channel.send({ files: [attachment], components: [row] }).then(async (msg) => {
