        ...
        if (oldState.guild.members.cache.get(client.user.id).voice.channel.members.size === 1) {
          ...
          if (channel) {
            const embed = new EmbedBuilder()
              ...
              .setAuthor({name:`Jai Siya Ram`, iconURL:client.user.displayAvatarURL()})
              .setDescription(`I Left The Voice Channel. Because No One Was Listening Music With me. Enable **247** Mode To Keep Me In VC.`
              );
